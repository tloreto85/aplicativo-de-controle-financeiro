...
| Prefixo      | Uso                                                        | Exemplo                          |
| ------------ | ---------------------------------------------------------- | -------------------------------- |
| `feature/`   | Nova funcionalidade                                        | `feature/lista-de-tarefas`       |
| `fix/`       | Correção de bug                                            | `fix/tarefa-nao-salva`           |
...
Exemplo:
```
feat: adiciona lista de tarefas por cômodo

Permite agrupar as tarefas domésticas por ambiente da casa,
facilitando a divisão do trabalho entre os moradores.
```
